...
// Components
class SoloOneself extends Component {
  render() {
...
const routes = (
  <Router history={browserHistory}>
    <Route path={constants.ROUTE_PATHS.ROOT} component={SoloOneself}>
...
AppRegistry.registerComponent('SoloOneself', () => () => routes)
AppRegistry.runApplication('SoloOneself', { rootTag: document.getElementById('react-root') })
